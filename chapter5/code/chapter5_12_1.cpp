...
const char dataFileName[30] = "dataset_369320_8.txt";// "test.txt";
const char dataFilePath[40] = "E:/GitHub/yizhou-zhong/chapter5/data/";
const char outputFileName[20] = "chapter5_12_1.txt";
...
int main(int argc, char *argv[])
{
	...
	int score;
	// operation
	vector<string> outputStrs = AffineGapPenaltiesProblem(str1, str2, 
		scoringChar, scoringMat, score);
