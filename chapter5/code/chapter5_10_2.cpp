...
const char dataFileName[30] = "dataset_369318_10.txt"; // "test.txt";
const char dataFilePath[40] = "E:/GitHub/yizhou-zhong/chapter5/data/";
const char outputFileName[20] = "chapter5_10_2.txt";
const char scoringMatFileName[20] = "PAM250.txt";
...
int main(int argc, char *argv[])
{
	...
	int scoreMax;
	// operation
	vector<string> outputStr = LoaclAlignProblem(str1, str2, 
