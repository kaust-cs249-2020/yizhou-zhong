...
const char dataFileName[30] = "dataset_369239_10.txt";
const char dataFilePath[40] = "E:/GitHub/yizhou-zhong/chapter1/data/";
const char outputFileName[20] = "chapter1_8_5.txt";
...
int main(int argc, char *argv[])
{
	...
	// operation
	vector<string> freqPatterns = FrequentWordsWithMismatchesAndReverse(&Text, k, d);
