...
const char dataFileName[30] = "dataset_369350_6.txt"; // "test.txt";
const char dataFilePath[40] = "E:/GitHub/yizhou-zhong/chapter8/data/";
const char outputFileName[20] = "chapter8_4_1.txt";
...
int main(int argc, char *argv[])
{
	...
	// operation
	vector<string> outStr = AdditivePhylogenyProblem(n, disMat);
