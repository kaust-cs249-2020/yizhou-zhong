...
const char dataFileName[30] = "dataset_369352_8.txt"; // "test.txt";
const char dataFilePath[40] = "../../../yizhou-zhong/chapter8/data/"; //"//"E:/GitHub/yizhou-zhong/chapter8/data/";
const char outputFileName[20] = "chapter8_6_1.txt";
...
int main(int argc, char *argv[])
{
	...
	// operation
	vector<string> outStr = UPGMA(n, disMat);
