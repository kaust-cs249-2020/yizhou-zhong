...
const char dataFileName[30] = "dataset_369273_6.txt";
const char dataFilePath[40] = "E:/GitHub/yizhou-zhong/chapter3/data/";
const char outputFileName[20] = "chapter3_8_2.txt";
...
int main(int argc, char *argv[])
{
	...
	vector<vector<bool>> nodeRoute(nodeNum+1, vector<bool>(nodeNum+1, false));// this is the matrix of graph
	int edgeCount = 0;
	...
	// operation
	vector<int> cycleRoute = EulerianPath(&nodeRoute);
